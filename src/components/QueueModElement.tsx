                    ...
                    return (
                        <li className={`${entry.style} ${entry.classN}`} {...provided.draggableProps} {...provided.dragHandleProps} ref={provided.innerRef}>
                            ...
                            <div className='button-group'>
                                <button onClick={changeQueueEntry}>Apply</button>
                                <button onClick={deleteQueueEntry}>{entry.delete_button_text}</button>
                                <button onClick={() => change_mod_view(index)}>{entry.button_text}</button>
                            </div>
